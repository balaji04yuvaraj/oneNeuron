...
def prepare_data(df):
    ...
    logging.info("Preparing the data by segregating dependent variables")
    X = df.drop("y", axis=1)
...
def save_plot(df, file_name, model):
    ...
    def _plot_decision_regions(X, y, classfier, resolution=0.02):
        logging.info("Now _plot_decision_regions")
    ...
    logging.info("Saving info for plot path")